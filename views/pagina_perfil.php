            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="pagina_principal.php">For You<span class="sr-only">(Página
                                atual)</span></a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="profile-header">
                    ...
                    <div class="profile-info">
                        <div class="profile-avatar">
                            <img src="<?php echo htmlspecialchars($user->getFotoPerfil()); ?>" alt="Avatar do Usuário"
                    ...
                    <div class="row">
                        <?php foreach ($livros as $livro): ?>
                            <div class="col-md-4 mb-4">
                                <div class="card">
                                    <img class="card-img-top book-icon"
                                        src="<?= htmlspecialchars($livro['caminho_capa']); ?>" alt="Capa do Livro"
                                        data-id="<?= $livro['id']; ?>"
    ...
    <div id="add-book-popup" class="popup-container">
        <div class="popup-content form-container">
            ...
            <form action="../controllers/user_controller.php" method="POST" enctype="multipart/form-data">
                ...
                <button type="submit" name="adicionar_lista" value="1" class="btn-submit">Adicionar Livro ao Banco e à
                    Lista</button>
