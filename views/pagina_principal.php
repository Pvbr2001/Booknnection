        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">    
                        <a class="nav-link" href="planos.html" target="_blank">Planos</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="col-left sidebar" id="sidebar-left">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body" id="ultimo-livro-trocado">
                        <img class="img-fluid" src="../public/imagens/book-cover.jpg"
                            alt="Capa do &Uacute;ltimo Livro Trocado" style="width: 50%; opacity: 0.5; margin: 0 auto;">
                                ...
                                <?php foreach ($posts as $post): ?>
                                    ...
                                    <div class="card mb-4">
                                        <div class="post-owner-info">
                                            <img src="<?= $fotoPerfil ? htmlspecialchars($fotoPerfil) : '../public/imagens/user-icon.png'; ?>"
                                                alt="Foto do Dono do Post">
                                            <h1><?= htmlspecialchars($post['nome']); ?></h1>
                                        </div>
                                        <img class="card-img-top" src="<?= htmlspecialchars($post['caminho_capa']); ?>"
                                            alt="Capa do Livro"
                                            style="width: auto; height: 500px; object-fit: cover; margin: 0 auto;">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex gap-2">
                                                ...
                                                <button type="button" id="send-request-btn"
                                                    class="btn btn-secondary ml-2 send-request-btn"
                                                    data-image="<?= htmlspecialchars($post['caminho_capa']); ?>"
                                                    data-id="<?= $post['id']; ?>"
                                                    data-nome="<?= htmlspecialchars($post['nome']); ?>"
                                                    data-owner-id="<?= $post['id_usuario']; ?>">
                                        ...
                                        <div class="card-footer text-muted">
                                            Postado por <a href="#"><?= htmlspecialchars($post['nome']); ?></a> no dia
                        ...
                        <div id="add-book-popup" class="popup-container">
                            <div class="popup-content form-container">
                                ...
                                <form action="../controllers/user_controller.php" method="POST"
                                    ...
                                    <button type="submit" name="adicionar_lista" value="1" class="btn-submit">Adicionar
                                        Livro ao Banco e à Lista</button>
                        ...
                        <div id="send-request-popup" class="popup-container">
                            <div class="popup-content">
                                ...
                                <div class="post-owner-info-popup">
                                    <img src="../public/imagens/user-icon.png" alt="Foto do Dono do Post"
                                        id="post-owner-image">
                                    <h1 id="post-owner-name"></h1>
                                </div>
                                <form id="send-request-form" action="../controllers/post_actions.php" method="POST"
                                    enctype="multipart/form-data">
                                    <input type="hidden" name="acao" value="trocar_livro">
                                    <input type="hidden" name="id_post" id="id_post" value="">
                                    <div class="post-info">
                                        <img src="" alt="Capa do Livro" id="imagem_post"
                                            style="width: auto; height: 300px;">
                                        <h1>Usuário atual: <span
                                                id="current-user"><?php echo $user->getNome(); ?></span> </h1>
                                    </div>
                                    <div class="form-group">
                                        <label for="livros_troca">Selecione os livros para troca:</label>
                                        <select class="form-control" id="livros_troca" name="livros_troca[]" multiple
                                            required>
                                            <?php
                                            $livros_usuario = $user->exibirLivrosFeed($_SESSION['user_id']);
                                            foreach ($livros_usuario as $livro): ?>
                                                <option value="<?= $livro['id']; ?>"
                                                    data-image="<?= $livro['caminho_capa']; ?>">
                        ...
                        <aside class="sidebar-right">
                            <div class="sidebar-section">
                                <ul>
                                    ...
                                    $sql = "SELECT * FROM vw_notificacoes WHERE id_usuario = ? ORDER BY data_criacao DESC";
                    ...
                    <div class="card-body" id="solicitacoes">
                        <aside class="sidebar-right">
                            <div class="sidebar-section">
                                <ul>
                                    <?php
                                    $sql = "SELECT * FROM vw_notificacoes WHERE id_usuario_emissor = ? ORDER BY data_criacao DESC";
                                    $stmt = $conn->prepare($sql);
                                    $stmt->bind_param("i", $id_usuario);
                                    $stmt->execute();
                                    $result = $stmt->get_result();
